...
describe('OwnerListComponent', () => {
    ...
    beforeEach(() => {
        ...
        spy = vi.spyOn(ownerService, 'getOwnersPage').mockReturnValue(of({
            content: testOwners,
            page: 0,
            size: 5,
    ...
    it(' should show full name after getOwnersPage observable (async) ', waitForAsync(() => {
        ...
        fixture.whenStable().then(() => {
            ...
            expect(component.owners, 'component renders the page envelope content').toEqual(testOwners);
            expect(component.owners.length, 'one owner in the mocked page').toEqual(1);
        });
    }));
